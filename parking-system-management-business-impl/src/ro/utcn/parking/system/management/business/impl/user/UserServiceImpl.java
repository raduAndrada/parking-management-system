package ro.utcn.parking.system.management.business.impl.user;
...
import ro.utcn.parking.system.management.business.api.user.UserService;
import ro.utcn.parking.system.management.data.api.user.UserEntity;
import ro.utcn.parking.system.management.data.impl.payment.options.PaymentOptionsRepository;
import ro.utcn.parking.system.management.data.impl.user.UserRepository;
import ro.utcn.parking.system.management.model.user.User;
...
public class UserServiceImpl implements UserService{
	...
	public User addUser(final User user) {
		...
		entity.setPaymentOptions(paymentOptionsRepo.getOne(user.getPaymentOptionsId()));
