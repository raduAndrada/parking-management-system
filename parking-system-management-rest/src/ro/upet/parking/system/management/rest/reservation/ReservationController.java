...
public class ReservationController extends BaseController<Reservation> {
    ...
    private static final String RESERVATION_NEXT_USERNAME_PATH = "/reservation-next/{username}";
    private static final String RESERVATION_CLAIM_PATH = "/claim/{reservationId}";
    private static final String RESERVATION_START_PATH = "/start/{reservationId}";
    private static final String RESERVATION_COMPLETE_PATH = "/complete/{reservationId}";
    ...
    public ResponseEntity<List<Reservation>> getReservationsForUser(@PathVariable final String username) {
        ...
        if (reservationList == null) {
            ...
            log.info("Reservations found for the user: {}", reservationList);
     ...
     * @return the list with all the reservations of a user
     */
    @GetMapping(RESERVATION_NEXT_USERNAME_PATH)
    public ResponseEntity<ReservationNext> getReservationNextForUser(@PathVariable final String username) {
        log.info("REST request to GET reservationsNEXT by username : {}", username);
