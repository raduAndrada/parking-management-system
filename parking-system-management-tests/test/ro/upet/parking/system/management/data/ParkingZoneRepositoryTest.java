...
public class ParkingZoneRepositoryTest extends DataTests {
    ...
    @Inject
    private ro.upet.parking.system.management.data.impl.parking.zone.ParkingZoneRepository parkingZoneRepo;
