...
public class PaymentOptionsRepositoryTest extends DataTests {
    ...
    @Inject
    private ro.upet.parking.system.management.data.impl.payment.options.PaymentOptionsRepository paymentOptionsRepo;
