...
public class MembershipRepositoryTest extends DataTests {
    ...
    @Inject
    private ro.upet.parking.system.management.data.impl.membership.MembershipRepository membershipRepo;
