...
import ro.upet.parking.system.management.business.impl.reservation.ReservationMapper;
...
public class ReservationServiceIT  {
	...
	public void testCreateReservation_success() {
		...
		when(validator.validate(1L,START_TIME_INSTANT, END_TIME_INSTANT)).thenReturn(true);
	...
	public void testCreateReservation_failNoSpotsAreValid() {
		...
		when(validator.validate(1L,START_TIME_INSTANT, END_TIME_INSTANT)).thenReturn(false);
		when(reservationRepo.save(any())).thenReturn(entity);
