...
public class VehicleServiceIT extends BusinessTests {
    ...
    private static final User USER = ImtUser.builder()
 			.name("Andrada")
 			.build();
    
    private static final Vehicle VEHICLE_1 = ImtVehicle.builder()
			.name(VEHICLE_NAME1)
			.licencePlate(VEHICLE_LICENCE_PLATE1)
			.size(Size.MEDIUM)
			.user(USER)
			.build();
