...
import static ro.upet.parking.system.management.util.TestDataEntityBuilder.buildReservationEntity;

@RunWith(SpringRunner.class)
public class ReservationValidatorImplIT {
    ...
    public void testValidateNoOtherReservations_success() {
        ...
        assertTrue(validator.validate(null, START_TIME_INSTANT, END_TIME_INSTANT));
    }
    ...
    public void testValidate_failCase1() {
        ...
        assertFalse(validator.validate(null, START_TIME_INSTANT, END_TIME_INSTANT));
    }
